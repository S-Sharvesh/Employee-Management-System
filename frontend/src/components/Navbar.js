...
const Navbar = () => {
  ...
  const drawerContent = (
    <Box sx={{ width: 250, background: 'linear-gradient(45deg, #1e3c72, #2a5298)', height: '100%', color: 'white' }} role="presentation">
      <List>
  ...
  return (
    <>
      <AppBar position="static" sx={{ background: 'linear-gradient(45deg, #1e3c72, #2a5298)', padding: '0.5rem 0' }}>
        <Toolbar>
          <Typography
            variant="h6"
            component={Link}
