      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Support Team:{' '}
              <Link href="mailto:contact@employeemanagement.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                Support Team
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:contact@employeemanagement.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                contact@employeemanagement.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 123456</Typography>
            <Typography variant="body2" sx={{ marginTop: '0.5rem' }}>
              Address: Your Addres Here, City, State, Zip Code
            </Typography>
          </Grid>
        </Grid>
