...
public class DepartmentController {
  ...
  public ResponseEntity<Department> getDepartmentById(
      @Parameter(description = "ID of the department to be retrieved") @PathVariable String id) {
  ...
  public ResponseEntity<Department> updateDepartment(
      @Parameter(description = "ID of the department to be updated") @PathVariable String id,
  ...
  public ResponseEntity<Void> deleteDepartment(
      @Parameter(description = "ID of the department to be deleted") @PathVariable String id) {
    Department department =
        departmentService
            .getDepartmentById(id)
            .orElseThrow(
